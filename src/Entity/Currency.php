...
class Currency
{
     ...
     * @Groups({"fournisseur:get-item-from-demande","visit:get-all","fournisseur:get-from-demande","currency:get-all","produit:get-all","demandeDevis:get-item","get-from-acheteur_demandes","get-from-demande"})
