...
class Ville
{
     ...
     * @Groups({"get-from-demande","item:get-from-demande","get-from-acheteurs_blacklistes","visit:get-for-acheteur","produit:get-all","abonnement:get-item","produit:get-item","dmdAbonnement:get-item","visit:get-all","get-from-ville","get","post","put"})
