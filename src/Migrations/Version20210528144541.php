 ...
 */
final class Version20210528144541 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX indexe_societe ON fournisseur');
        $this->addSql('DROP INDEX indexe_fournisseur ON fournisseur');
        ...
        $this->addSql('CREATE INDEX indexe_societe ON fournisseur (societe_lower)');
        $this->addSql('CREATE INDEX indexe_fournisseur ON fournisseur (societe)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX indexe_fournisseur ON fournisseur (societe(191))');
        $this->addSql('CREATE INDEX indexe_societe ON fournisseur (societe_lower(191))');
        $this->addSql('ALTER TABLE fournisseur_provisoire CHANGE fournisseur_parent_id fournisseur_parent_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE historique_visite CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE demande_id demande_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE produit ADD CONSTRAINT FK_29A5EC276E694C1F FOREIGN KEY (featured_image_id_id) REFERENCES image_produit (id)');
        $this->addSql('ALTER TABLE secteur CHANGE image_id image_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE select_produit CHANGE produit_id produit_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE sous_secteur CHANGE secteur_id secteur_id INT DEFAULT NULL');
