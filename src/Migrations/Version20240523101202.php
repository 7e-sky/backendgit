 ...
 */
final class Version20240523101202 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediateur ADD blacklistes_id INT DEFAULT NULL, CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE acheteur_id acheteur_id INT DEFAULT NULL, CHANGE deblacklister deblacklister DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE mediateur ADD CONSTRAINT FK_617C17B8F21FD913 FOREIGN KEY (blacklistes_id) REFERENCES black_listes (id)');
        $this->addSql('CREATE INDEX IDX_617C17B8F21FD913 ON mediateur (blacklistes_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jeton CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE paiement_id paiement_id INT DEFAULT NULL, CHANGE demande_id demande_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediateur DROP FOREIGN KEY FK_617C17B8F21FD913');
        $this->addSql('DROP INDEX IDX_617C17B8F21FD913 ON mediateur');
        $this->addSql('ALTER TABLE mediateur DROP blacklistes_id, CHANGE acheteur_id acheteur_id INT DEFAULT NULL, CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE deblacklister deblacklister DATETIME DEFAULT \'NULL\'');
