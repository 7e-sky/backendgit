 ...
 */
final class Version20240523083210 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediateur DROP blackliste_id, DROP stop, CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE acheteur_id acheteur_id INT DEFAULT NULL, CHANGE raison raison LONGTEXT NOT NULL, CHANGE created created DATETIME NOT NULL, CHANGE etat etat TINYINT(1) NOT NULL, CHANGE deblacklister deblacklister DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE mediateur ADD CONSTRAINT FK_617C17B896A7BB5F FOREIGN KEY (acheteur_id) REFERENCES acheteur (id)');
        $this->addSql('ALTER TABLE mediateur ADD CONSTRAINT FK_617C17B8670C757F FOREIGN KEY (fournisseur_id) REFERENCES fournisseur (id)');
        $this->addSql('CREATE INDEX IDX_617C17B896A7BB5F ON mediateur (acheteur_id)');
        $this->addSql('CREATE INDEX IDX_617C17B8670C757F ON mediateur (fournisseur_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE jeton CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE paiement_id paiement_id INT DEFAULT NULL, CHANGE demande_id demande_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mediateur DROP FOREIGN KEY FK_617C17B896A7BB5F');
        $this->addSql('ALTER TABLE mediateur DROP FOREIGN KEY FK_617C17B8670C757F');
        $this->addSql('DROP INDEX IDX_617C17B896A7BB5F ON mediateur');
        $this->addSql('DROP INDEX IDX_617C17B8670C757F ON mediateur');
        $this->addSql('ALTER TABLE mediateur ADD blackliste_id INT NOT NULL, ADD stop VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE acheteur_id acheteur_id INT DEFAULT NULL, CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE raison raison VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created created VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE deblacklister deblacklister DATETIME DEFAULT \'NULL\', CHANGE etat etat VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
