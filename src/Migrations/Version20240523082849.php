 ...
 */
final class Version20240523082849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mediateur DROP stop, CHANGE fournisseur_id fournisseur_id INT DEFAULT NULL, CHANGE acheteur_id acheteur_id INT DEFAULT NULL, CHANGE raison raison LONGTEXT NOT NULL, CHANGE created created DATETIME NOT NULL, CHANGE etat etat TINYINT(1) NOT NULL, CHANGE deblacklister deblacklister DATETIME DEFAULT NULL');
